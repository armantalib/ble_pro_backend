...
exports.getZoneApp = async (req, res) => {
  let query = {};
...
exports.getZoneAdmin = async (req, res) => {
  ...
  try {
    const data = await Zone.find(query).skip(skip)
      .limit(pageSize).lean();
...
exports.deleteZone = async (req, res) => {
  try {
    ...
    const service = await Zone.findByIdAndDelete(serviceId);
